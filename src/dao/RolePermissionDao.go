...
type RolePermissionDao interface {
	InsertRolePermission(list []models.RolePermission) (int64, error)
	DeleteRolePermissions(list []models.RolePermission) (int64, error)
	QueryPermissionIdsByRoleId(roleId int) ([]int, error)
	QueryPermissionsByUser(userRole models.UserRole) ([]models.Permission, error)
}
...
func (rp *rolePermissionDao) InsertRolePermission(list []models.RolePermission) (int64, error) {
	//"roleid", roleid
...
// 删除role_permission
func (rp *rolePermissionDao) DeleteRolePermissions(list []models.RolePermission) (int64, error) {
...
// 根据角色id，查找权限id
func (rp *rolePermissionDao) QueryPermissionIdsByRoleId(roleId int) ([]int, error) {
...
// 根据角色，查找权限
func (rp *rolePermissionDao) QueryPermissionsByUser(userRole models.UserRole) ([]models.Permission, error) {
